  ...
  return (
    <section id="deploy" className="relative border-t border-rule">
      ...
      <div className="mx-auto max-w-6xl px-5 py-20 lg:py-28">
        <Reveal>
          <p className="kicker text-accent">vi &mdash; the dominions</p>
          ...
          <p className="lede-copy mt-5 max-w-xl">
            Run Pantheon fully managed, inside your own cloud account, or on
            hardware that makes no outbound calls at all. When the war was
            won, the brothers drew lots for the cosmos - the heavens, the
            sea, the world below. Choose your dominion; the agents serve in
            all three.
          </p>
        </Reveal>
