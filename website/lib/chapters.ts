...
export const CHAPTERS: Chapter[] = [
  ...
  },
  {
    ...
    numeral: "ii",
    label: "Workflows",
    headlineLead: "Workflows are defined as",
    headlineEmph: "data, not code.",
    lede: "Every automation is a set of YAML definitions that compile into a typed graph before anything runs. Invalid definitions are rejected before they register, with errors naming the file, the field, and the rule violated. The engine itself never changes for your business, no matter how many automations you add.",
    blurb: "Definitions are YAML that compiles into a typed graph, with every edge derived from a reference.",
    art: "herakles",
    artHeight: 700,
  ...
  },
  {
    ...
    headlineLead: "A run only touches what",
    headlineEmph: "its caller is allowed to touch.",
    lede: "Every resource call goes through a proxy that holds the credentials and checks the call against the grants issued for that run; the container never sees a secret. Everything the run did is recorded.",
