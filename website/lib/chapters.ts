...
export const CHAPTERS: Chapter[] = [
  {
    ...
    numeral: "i",
    name: "the works",
    headlineLead: "Some work runs itself.",
    headlineEmph: "Some you ask for.",
    ...
    blurb: "The two ways work starts here, and the range of what the work can be.",
    art: "olympus",
    artHeight: 620,
    title: "Automations - What Pantheon Runs | Obsidura",
    description:
      "Pantheon automates work across the systems your information is scattered across: background jobs on a schedule, and named processes anyone permitted can call by button or in plain English.",
  },
  {
    slug: "workflows",
    numeral: "ii",
