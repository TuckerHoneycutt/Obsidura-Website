  ...
  return (
    <main id="content" tabIndex={-1} className="flex-1">
      <section className="relative">
        {/* From lg the page splits: the deny line on the left, the way
            back in beside it. */}
        <div className="mx-auto grid max-w-shell gap-14 px-gutter pt-16 pb-20 lg:grid-cols-[minmax(0,5fr)_minmax(0,6fr)] lg:items-end lg:gap-[clamp(3rem,5vw,6rem)] lg:pt-24 lg:pb-28">
          <div className="max-w-3xl">
            ...
            <div className="mt-10 border border-rule bg-paper-warm/40 px-4 py-3">
              <p className="flex flex-wrap gap-x-3 font-mono text-[0.78125rem] leading-relaxed">
